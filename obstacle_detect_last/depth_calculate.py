...
class DepthProcessor(Node):
    def __init__(self):
        ...
        self.declare_parameters(
            ...
            parameters=[
                ...
                ('roi_height', 600),  # ROI 高度
                ('num_slices', 100),  # 水平切片数
                ('min_depth', 0.02),# 最小深度
                ('max_depth', 4),  # 最大深度
                ('fx', 640.910400390625), ('fy', 384.5462341308594), 
    ...
    def update_params(self):
        ...
        # self.roi_height = max(10, min(base_params[3].value, 720-self.roi_y))  # 移除高度限制
        self.roi_height = base_params[3].value #直接使用參數高度
    ...
    def process_depth(self, img):
        ...
        y_end = min(720, y_start + self.roi_height) # 添加邊界檢查
